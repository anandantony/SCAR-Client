...
public class DetectionYolox : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        modelData = await MLModelData.FromHub("@natsuite/yolox", accessKey);
    ...
    void Update()
    {
        ...
        foreach (var detection in detections)
        {
            ...
            var _length = _rect.height * 0.46f;
